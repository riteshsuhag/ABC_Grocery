...
# printing the output -
print(f"Probability of customer signing up = {round(prediction_output["Probability"], 3)}")
...
if check_input:
    ...
    prediction_output = requests.post("https://ml-api-ritesh.herokuapp.com/get_signup_probability/",json=params)

    prediction_output = prediction_output.json()
    
    col1, col2, col3 = st.columns((1,3,1))
    col2.markdown(f"""### Probability of customer signing up - {round(prediction_output["Probability"], 3)}""")
